...
- **דמויות:** ב-50% מהפעמים התרחיש יהיה מול תלמידים (בעיות משמעת, סרבנות, חרמות), ב-25% מול הורים, וב-25% מול איש צוות (הנהלה, סייעת, מורה מקבילה).
- **זירה/מיקום:** ב-50% מהפעמים האירוע יתרחש בתוך הכיתה בזמן שיעור, וב-50% מחוץ לשיעור (בחצר, בחדר מורים, בטיול, בוואטסאפ).
