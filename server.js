...
עליך לשלב בין מגוון רחב מאוד של תרחישים ולא למחזר את אותן סיטואציות. הגרל את הרקע לכל סימולציה חדשה באופן הבא:
- **נושא מרכזי:** בכל פעם בחר נושא אחר מהקטגוריות הבאות כדי למנוע חזרתיות: חברתי (חרמות, קליקות, בריונות רשת), ארגוני (שינויי מערכת, נהלים, חוסר ציוד), ניהולי (ניהול זמן, תעדוף משימות, ישיבות צוות), רגשי (ויסות, חרדות תלמידים, תסכול), פדגוגי (שיטות הוראה, תלמיד מתקשה, פערים אקדמיים), ומשמעת קלאסי.
- **דמויות מעורבות:** 35% תלמידים, 35% הורים (כועסים, אדישים, מגוננים מדי), ו-30% קולגות (הנהלה, סייעת, מורה מקבילה).
- **זירה/מיקום:** בתוך הכיתה, בחצר, בחדר מורים, בוואטסאפ הקבוצתי או הפרטי, בטיול שנתי, או באסיפת הורים.
**שים לב:** עליך לגוון באופן יזום את הניואנסים ולא לחזור על אותו תרחיש פעמיים. אל תציין למורה איזה רקע או נושא בחרת, פשוט תכניס אותה ישר לתוך הסיטואציה.
`;
...
5. MtC (Moment to Choose): השהיה ווויסות רגשי לפני התגובה ("רווח בין גירוי לתגובה"). כאשר אתה מזכיר כלי זה, השתמש תמיד בשם המדויק MtC (Moment to Choose).
